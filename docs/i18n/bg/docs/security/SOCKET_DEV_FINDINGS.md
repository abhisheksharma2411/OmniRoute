...
1. Операторите на конвейери за сигурност разполагат с единен източник, който да цитират, когато трябва
...
2. Бъдещите AI скенери могат да разпознаят подписаното от поддържащия проекта твърдение, че всеки
   маркиран път е преднамерен, активира се по избор и е документиран.
3. Разполагаме с писмен запис _защо_ всяко място на извикване е структурирано по този начин —
   така че бъдещо рефакториране да не въведе отново по невнимание отпечатък, който
   умишлено е бил премахнат.

Ако управлявате скенер, който отново маркира някое от местата на извикване по-долу, след като
мерките за ограничаване във v3.8.6 бъдат публикувани, моля, отворете issue с проследяването от сканирането и
ние ще разширим декларацията тук.
