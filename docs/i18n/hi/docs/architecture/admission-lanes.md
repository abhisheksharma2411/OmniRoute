...
## 1. बाइट-स्तरीय प्रोसेस-व्यापी प्रवेश (`chatBodyAdmission.ts`)

- **स्कोप:** `POST /v1/chat/completions`, `/v1/messages`, `/v1/responses`,
  और चैट-जैसे अन्य रूटों के लिए बफ़र की गई बॉडी/हीप पथ। बड़ी कोडिंग-एजेंट
  बॉडी के कारण होने वाले हीप विस्तार से सुरक्षा करता है (#4380)।
- **एक प्रोसेस-ग्लोबल नियंत्रक, प्रति-कुंजी लेन नहीं (#10110)।** प्रत्येक API कुंजी
  (हैश की गई) या `anonymous` सत्र **समान** साझा बजट के विरुद्ध प्रवेश पाता है —
  हैश किए गए सत्र आईडी का उपयोग केवल निष्पक्षता शेड्यूलिंग कुंजी के रूप में
  (प्रतीक्षारत अनुरोधों के बीच राउंड-रॉबिन डिस्पैच) किया जाता है, क्षमता शार्ड के
  रूप में कभी नहीं। इस दस्तावेज़ के पिछले संस्करण में स्वतंत्र क्षमता वाली
  प्रति-कुंजी लेन का वर्णन था; उस मॉडल को #10110 में हटा दिया गया, क्योंकि वह
  अप्रमाणित नकली क्रेडेंशियल को प्रोसेस-व्यापी सीमा कई गुना बढ़ाने देता था।
- **गेट (#503-fanout): स्वतः-व्युत्पन्न इनजेस्ट BYTE बजट, निश्चित अनुरोध
  संख्या नहीं।** पुरानी `CHAT_MAX_HEAVY_IN_FLIGHT` अनुरोध-संख्या सीमा (इस
  सुधार से पहले डिफ़ॉल्ट `1`) ने कोडिंग-एजेंट फ़ैन-आउट (एकाधिक सबएजेंट/CLI,
  बॉडी सामान्यतः > 256 KB) को ~1 की प्रभावी समवर्ती क्षमता तक सीमित कर दिया
  था, जिससे पूरी तरह सामान्य लोड के अंतर्गत 503 त्रुटियाँ आती थीं। अब यह केवल
  तभी बाध्यकारी होती है, जब कोई ऑपरेटर स्पष्ट रूप से
  `OMNIROUTE_CHAT_MAX_HEAVY_IN_FLIGHT` सेट करता है। इसे सेट न करने पर प्रवेश
  को इसके बजाय `OMNIROUTE_CHAT_MAX_INFLIGHT_BYTES` द्वारा नियंत्रित किया जाता
  है — यह प्रोसेस की वास्तविक मेमोरी सीमा
  (`src/shared/middleware/admissionBudget.ts`) से स्वतः-व्युत्पन्न बजट है:
  V8 हीप सीमा और किसी भी cgroup/कंटेनर सीमा में से अधिक सख्त सीमा का 25%,
  जिसे 8x अस्थायी-विस्तार गुणक से विभाजित करके 8 MiB और 2 GiB के बीच सीमित
  किया जाता है। स्पष्ट ओवरराइड भी इन्हीं सीमाओं का उपयोग करते हैं। यह बिना
  किसी env समायोजन के स्वयं को 512 MB कंटेनर से लेकर 32 GB डेस्कटॉप तक
  स्केल करता है। जो बॉडी प्रभावी बजट के भीतर फ़िट नहीं हो सकती, वह तुरंत
  `413 body_exceeds_budget` के साथ विफल हो जाती है; केवल अलग-अलग रूप से
  सेवायोग्य बॉडी के बीच संसाधन-संघर्ष ही सीमित निष्पक्षता कतार में प्रवेश
  करता है। एक लाइव बहु-संकेत संसाधन-दबाव ट्रैकर (V8 हीप अनुपात,
  cgroup, PSI, OOM घटनाएँ — `open-sse/utils/resourcePressurePolicy.ts`)
  `high` दबाव के अंतर्गत सीमित प्रतीक्षा अवधि कम करता है और `critical` दबाव
  के अंतर्गत, किसी भी बाइट को इनजेस्ट किए जाने से पहले ही,
  `503 resource_pressure` के साथ लोड तुरंत कम करता है।
- **समायोजन:**
  ...
  - `OMNIROUTE_CHAT_VIRTUAL_TTL_MS` / `OMNIROUTE_CHAT_VIRTUAL_MAX_SESSIONS` — #10110
    के बाद से बहिष्कृत और निष्प्रभावी (कॉन्फ़िगरेशन संगतता के लिए स्वीकार किए जाते हैं, पर अनदेखे किए जाते हैं)
- **रिपोर्ट:** `GET /api/monitoring/health` → `chatAdmission` (#11244) — इसमें
  ...
  शामिल हैं (डिफ़ॉल्ट डिप्लॉयमेंट पर false — यह पुष्टि करता है कि वास्तव में
  बाइट बजट बाध्यकारी है, पुरानी अनुरोध-संख्या सीमा नहीं)।
