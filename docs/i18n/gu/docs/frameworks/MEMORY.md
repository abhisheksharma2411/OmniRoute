...
`src/shared/schemas/memory.ts` માં `MemorySettingsExtended` માટે નવ એમ્બેડિંગ અને વેક્ટર ફીલ્ડ ઉપલબ્ધ છે, જે `src/lib/db/settings.ts` મારફતે સ્થાયી રીતે સંગ્રહિત થાય છે:

| ફીલ્ડ                    | પ્રકાર                                             | ડિફૉલ્ટ  | વર્ણન                                                             |
| ------------------------ | -------------------------------------------------- | -------- | ----------------------------------------------------------------- |
| `embeddingSource`        | `"remote" \| "static" \| "transformers" \| "auto"` | `"auto"` | કયા એમ્બેડિંગ સ્રોતનો ઉપયોગ કરવો                                  |
| `embeddingProviderModel` | `string \| null`                                   | `null`   | `provider/model` ફોર્મેટમાં પ્રદાતા/મોડેલ                         |
| `customBaseUrl`          | `string \| null`                                   | `null`   | ફક્ત મેમરી માટેનો OpenAI-સુસંગત એન્ડપોઇન્ટ બેઝ URL                |
| `customModelId`          | `string \| null`                                   | `null`   | કસ્ટમ એન્ડપોઇન્ટને મોકલવામાં આવતી મોડેલ ID                        |
| `transformersEnabled`    | `boolean`                                          | `false`  | Transformers.js માટે ઑપ્ટ-ઇન (MiniLM, ~400MB)                     |
| `staticEnabled`          | `boolean`                                          | `false`  | સ્થિર potion-base-8M સ્થાનિક મોડેલ માટે ઑપ્ટ-ઇન                   |
| `rerankEnabled`          | `boolean`                                          | `false`  | પુનઃક્રમનિર્ધારણ પગલું સક્ષમ કરો (દર વિનંતીએ +200-500ms ઉમેરે છે) |
| `rerankProviderModel`    | `string \| null`                                   | `null`   | `provider/model` ફોર્મેટમાં પુનઃક્રમનિર્ધારણ પ્રદાતા/મોડેલ        |
| `vectorStore`            | `"sqlite-vec" \| "qdrant" \| "auto"`               | `"auto"` | કયા વેક્ટર બૅકએન્ડનો ઉપયોગ કરવો                                   |

આને `GET /PUT /api/settings/memory` (સ્કીમા `MemorySettingsExtendedSchema`) મારફતે ઉપલબ્ધ કરાવવામાં આવ્યા છે.

`remote` સ્રોત માટે, Memory વૈકલ્પિક `customBaseUrl` અને
`customModelId` સેટિંગ્સ પણ સ્વીકારે છે. બંને સાથે મળીને વૈશ્વિક એમ્બેડિંગ રજિસ્ટ્રી બદલ્યા વિના OpenAI-સુસંગત `/embeddings`
એન્ડપોઇન્ટ અને મોડેલ પસંદ કરે છે. ઉપયોગ પહેલાં એન્ડપોઇન્ટને
સામાન્યીકૃત કરવામાં આવે છે અને પ્રદાતાની આઉટબાઉન્ડ URL નીતિ દ્વારા તેની ચકાસણી કરવામાં આવે છે: HTTP(S)
આવશ્યક છે, એમ્બેડ કરેલા ક્રેડેન્શિયલ્સ અને ક્વેરી સ્ટ્રિંગ્સ નકારવામાં આવે છે, અને ક્લાઉડ-મેટાડેટા
સરનામાં અવરોધિત રહે છે. ખાલી મૂલ્યો પસંદ કરેલા રજિસ્ટ્રી પ્રદાતાને યથાવત્ રાખે છે. ડેશબોર્ડને
પરત કરવામાં આવતી ભૂલોને સેનિટાઇઝ કરવામાં આવે છે અને એન્ડપોઇન્ટ ક્રેડેન્શિયલ્સ ક્યારેય લૉગ કરવામાં આવતા નથી.

> **TODO (D20):** `global` સ્કોપ (તમામ API કીઝમાં મેમરીઝ શેર કરવી) આ રિલીઝમાં
> અમલમાં મૂકવામાં આવ્યો નથી. તેના માટે સ્કીમામાં ફેરફારો અને વૈશ્વિક પુનઃપ્રાપ્તિ
